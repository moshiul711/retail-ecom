        ...
        <div class="card">
            <div class="row g-0">
                <div class="col-md-4 border-end">
                    <img id="mainImage" src="<?php echo e(asset('/')); ?>website/assets/images/products/13.png" class="img-fluid"
                        alt="...">
                    <div class="row mb-3 row-cols-auto g-2 justify-content-center mt-3">
                        <div class="col">
                            <img src="<?php echo e(asset('/')); ?>website/assets/images/products/20.webp" width="70"
                                class="border rounded cursor-pointer" onclick="changeImage(this)" alt="">
                        </div>
                        <div class="col">
                            <img src="<?php echo e(asset('/')); ?>website/assets/images/products/11.png" width="70"
                                class="border rounded cursor-pointer" onclick="changeImage(this)" alt="">
                        </div>
                        <div class="col">
                            <img src="<?php echo e(asset('/')); ?>website/assets/images/products/14.png" width="70"
                                class="border rounded cursor-pointer" onclick="changeImage(this)" alt="">
                        </div>
        ...
        <div class="row row-cols-2 row-cols-sm-3 row-cols-md-4 row-cols-lg-4 row-cols-xl-5 row-cols-xxl-5 product-grid">
            <div class="col">
                <div class="card">
                    <div class="row g-0">
                        <div class="col-md-4">
                            <img src="<?php echo e(asset('/')); ?>website/assets/images/products/01.png" class="img-fluid"
                                alt="...">
                        </div>
                        <div class="col-md-8">
                            <div class="card-body">
            ...
            <div class="col">
                <div class="card">
                    <div class="row g-0">
                        <div class="col-md-4">
                            <img src="<?php echo e(asset('/')); ?>website/assets/images/products/02.png" class="img-fluid"
                                alt="...">
                        </div>
                        <div class="col-md-8">
                            <div class="card-body">
            ...
            <div class="col">
                <div class="card">
                    <div class="row g-0">
                        <div class="col-md-4">
                            <img src="<?php echo e(asset('/')); ?>website/assets/images/products/20.webp" class="img-fluid"
                                alt="...">
                        </div>
                        <div class="col-md-8">
                            <div class="card-body">
            ...
            <div class="col">
                <div class="card">
                    <div class="row g-0">
                        <div class="col-md-4">
                            <img src="<?php echo e(asset('/')); ?>website/assets/images/products/03.png" class="img-fluid"
                                alt="...">
                        </div>
                        <div class="col-md-8">
                            <div class="card-body">
            ...
            <div class="col">
                <div class="card">
                    <div class="row g-0">
                        <div class="col-md-4">
                            <img src="<?php echo e(asset('/')); ?>website/assets/images/products/04.png" class="img-fluid"
                                alt="...">
                        </div>
                        <div class="col-md-8">
                            <div class="card-body">
...
<?php echo $__env->make('master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Projects\rocker-ecom\resources\views/website/products/detail.blade.php ENDPATH**/ ?>