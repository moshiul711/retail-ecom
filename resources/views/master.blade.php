...
<head>
    ...
    <!--plugins-->
    <link href="{{ asset('/') }}website/assets/plugins/simplebar/css/simplebar.css" rel="stylesheet" />
    <link href="{{ asset('/') }}website/assets/plugins/perfect-scrollbar/css/perfect-scrollbar.css"
        rel="stylesheet" />
    <link href="{{ asset('/') }}website/assets/plugins/metismenu/css/metisMenu.min.css" rel="stylesheet" />
    ...
    <link href="{{ asset('/') }}website/assets/css/app.css" rel="stylesheet">
    <link href="{{ asset('/') }}website/assets/css/icons.css" rel="stylesheet">
...
<body>
    ...
    <div class="wrapper">
            ...
            <a href="{{ route('website') }}">
                <div class="sidebar-header">
                    <div class="text-center">
                        <img src="{{ asset('/') }}website/assets/images/logo-email.png" class="logo-icon"
                            alt="logo icon">
                    </div>
                </div>
            </a>
                                ...
                                <div class="dropdown-menu dropdown-menu-end">
                                            ...
                                            <div class="d-flex align-items-center gap-3">
                                                <div class="position-relative">
                                                    <div class="cart-product rounded-circle bg-light">
                                                        <img src="{{ asset('/') }}website/assets/images/products/11.png"
                                    ...
                                    <a href="javascript:;">
                                        <div class="text-center msg-footer">
                                            ...
                                            <a href="{{ route('checkout') }}" class="btn own-btn">Checkout</a>
                                        </div>
                                    </a>
                                </div>
                            </li>
                    ...
                    <div class="user-box dropdown ps-3">
                        <a class="d-flex align-items-center nav-link dropdown-toggle gap-3 dropdown-toggle-nocaret"
                            ...
                            @if (!session('customer_id'))
                                <img src="{{ asset('/') }}website/assets/images/avatars/avatar.png"
        ...
        <div class="page-wrapper">
            <div class="page-content">
                @yield('carousel')
                @yield('product-overview')
                @yield('featured-category')
    ...
    <script src="{{ asset('/') }}website/assets/plugins/metismenu/js/metisMenu.min.js"></script>
