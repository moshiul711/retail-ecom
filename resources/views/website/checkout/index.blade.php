                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="checkout-products">
                            ...
                            <div class="row border-bottom mb-1">
                                <div class="col-2">
                                    <img src="{{ asset('/') }}website/assets/images/products/02.png" class="product-img-2" alt="product img">
                                </div>
                                <div class="col-10">
                                    <p style="margin-bottom: 0rem">Off-White Odsy-1000 Men Half T-Shirt</p>
                                    <p style="margin-bottom: 0rem">Price: ৳ 2000</p>
                            ...
                            <div class="row border-bottom mb-1">
                                <div class="col-2">
                                    <img src="{{ asset('/') }}website/assets/images/products/03.png" class="product-img-2" alt="product img">
                                </div>
                                <div class="col-10">
                                    <p style="margin-bottom: 0rem">Off-White Odsy-1000 Men Half T-Shirt</p>
                                    <p style="margin-bottom: 0rem">Price: ৳ 2000</p>
